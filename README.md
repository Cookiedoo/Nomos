...
```mermaid
graph TD
    classDef layer fill:#0d1117,stroke:#58a6ff,stroke-width:2px,color:#c9d1d9;
    
    L6[L6: Meta-Cognition & Elastic Weight Consolidation]:::layer
    L5[L5: Transduction Runtime & Dual Presentation]:::layer
    L4[L4: System 1 Guidance - Asymmetric Pinned DMA]:::layer
    L3[L3: Topological Routing - Bidirectional Wavefronts]:::layer
    L2[L2: Invariant Engine - Static Torque Equilibrium]:::layer
    L1[L1: Volumetric Cache Substrate - Linear SVO]:::layer
    L0[L0: Bare-Metal Contract - Arena Pools]:::layer
